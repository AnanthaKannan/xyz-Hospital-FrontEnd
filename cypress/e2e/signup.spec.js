...
describe('Signup', () => {
  ...
  it('Error validation by submit wrong value', () => {
    ...
    cy.get('#error-name').should('have.text', 'Name must be at least 6 characters');
    cy.get('#error-address').should('have.text', 'Address must be at least 6 characters');
    cy.get('#error-phone_number').should('have.text', 'Phone Number must be at least 6 digit');
