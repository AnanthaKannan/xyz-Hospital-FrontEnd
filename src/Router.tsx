...
const ConfirmationCodeComp = lazy(
  () => import("./CognitoComp/ConfirmationCodeComp")
);
const ForgotPasswordComp = lazy(
  () => import("./CognitoComp/ForgotPasswordComp")
);
const ChangePasswordComp = lazy(
  () => import("./CognitoComp/ChangePasswordComp")
);
